...
optics = OPTICS(min_samples=100, xi=0.1, min_cluster_size=0.05)
...
# Заголовок графика
plt.title('OPTICS для первой маски красного цвета', fontsize=20, fontweight="bold")
