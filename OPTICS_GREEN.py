...
hue_min, hue_max = 58, 88
sat_min, sat_max = 150, 255
val_min, val_max = 77, 255
...
optics = OPTICS(min_samples=2000, xi=0.02, min_cluster_size=0.05)
...
# Заголовок графика
plt.title('OPTICS для зеленого цвета', fontsize=20, fontweight="bold")
