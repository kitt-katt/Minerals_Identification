...
data1, data2, data3 = usingMask(imageInHSV, 172, 180, 105, 255, 89, 255)

# Применяем DBSCAN для кластеризации
cluster_labels, data = dbscan_clustering(data1, data2, data3, eps=7, min_samples=100)
...
plt.title("DBSCAN для второй маски красного цвета", fontsize = 25, fontweight = "bold")
