...
data1, data2, data3 = usingMask(imageInHSV, 0, 7, 114, 255, 77, 255)

# Применяем DBSCAN для кластеризации
cluster_labels, data = dbscan_clustering(data1, data2, data3, eps=3, min_samples=100)
...
plt.title("DBSCAN для первой маски красного цвета", fontsize = 25, fontweight = "bold")
