...
data1, data2, data3 = usingMask(imageInHSV, 58, 88, 150, 255, 77, 255)

# Применяем DBSCAN для кластеризации
cluster_labels, data = dbscan_clustering(data1, data2, data3, eps=5, min_samples=200)
...
plt.title("DBSCAN для зеленого цвета", fontsize = 25, fontweight = "bold")
